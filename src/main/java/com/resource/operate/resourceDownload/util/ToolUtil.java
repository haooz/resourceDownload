...
import com.zkhc.znkf.core.support.StrKit;
import com.zkhc.znkf.core.util.DateUtil;
...
//	}
    ...
    public static String getWebRootPath(String filePath) {
        try {
            String path = com.zkhc.znkf.core.util.ToolUtil.class.getClassLoader().getResource("").toURI().getPath();
            path = path.replace("/WEB-INF/classes/", "");
            path = path.replace("/target/classes/", "");
            path = path.replace("file:/", "");
            if (com.zkhc.znkf.core.util.ToolUtil.isEmpty(filePath)) {
                return path;
            } else {
    ...
    public static String getFileSuffix(String fileWholeName) {
        if (com.zkhc.znkf.core.util.ToolUtil.isEmpty(fileWholeName)) {
            return "none";
        }
